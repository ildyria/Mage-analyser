...
echo '</select><br />'."\n";
echo "\t"."\t"."\t".'trinket Sinestra <span class="c17">*</span> : <select name="sinestra"><option value="non">non</option>';
echo '<option value="oui">oui</option>';
echo '</select><br />'."\n";
...
echo "\t"."\t"."\t"."\t".'<span id="txtlog">Copiez collez la requete dans <i>Expression Editor</i></span><br />'."\n";
echo "\t"."\t"."\t".'</div>'."\n";
...
echo "\t"."\t"."\t".'Log de Trunkot sur un wype de Ragnaros : <br />'."\n";
echo "\t"."\t"."\t".'<a href="ragna.txt">log de d&eacute;g&acirc;ts</a><br />'."\n";
echo "\t"."\t"."\t".'Langue : fran&ccedil;ais, spé : arcane, intel : 5306, hate : 1450<br />'."\n"; 
echo "\t"."\t"."\t".'</div>'."\n";
echo "\t"."\t"."\t".'<div style="padding-top: 50px;">'."\n";
echo "\t"."\t"."\t".'<a href="manual.php">FAQ</a><br />'."\n";
echo "\t"."\t"."\t".'</div>'."\n";
echo "\t"."\t".'</td>'."\n";
echo "\t".'</tr>'."\n";
echo "\t".'<tr>'."\n";
